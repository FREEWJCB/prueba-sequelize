...
interface TableSortDtoConstructor {
  created_at?: SortOrder;
  name?: SortOrder;
}

export class TableSortDto implements Record<string, SortOrder> {
  [key: string]: SortOrder;

  constructor(dto: TableSortDtoConstructor | undefined = undefined) {
    if (dto?.created_at) {
